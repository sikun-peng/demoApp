...
public class PictureController {
    ...
    public static final String MOOD_FREQUENCY = "/frequency/{mood}";
    ...
    public int getFrequency(@PathVariable Mood mood) throws Exception {
        return pictureService.frequency(mood);
    }
    ...
    public Integer addPicture(@RequestParam Mood mood, @RequestParam Double longitude,  @RequestParam Double latitude ) {
    		LOGGER.info("add cutomers");
    		return pictureService.createPicture(mood, latitude, longitude).getId();
    }
}
